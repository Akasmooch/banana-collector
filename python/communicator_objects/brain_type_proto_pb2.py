...
DESCRIPTOR: banana = _descriptor.FileDescriptor (
    name='communicator_objects/brain_type_proto.proto',
    package='communicator_objects',
    syntax='proto3',
    serialized_pb=_b('\n+communicator_objects/brain_type_proto.proto\x12\x14\x63communicator_objects\x1a'
                      '+communicator_objects/resolution_proto.proto*G\n\x0e\x42rainTypeProto\x12\n\n\x06Player\x10\x00'
                      '\x12\r\n\tHeuristic\x10\x01\x12\x0c\n\x08\x45external\x10\x02\x12\x0c\n\x08Internal\x10\x03\x42'
                      '\x1f\xaa\x02\x1cMLAgents.CommunicatorObjects\x06proto3')
    ,
...
DESCRIPTOR._options = _descriptor._ParseOptions(_descriptor.FileOptions(),_b('\252\002\034MLAgents.CommunicatorObjects'))
